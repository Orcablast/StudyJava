...
contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%> <% // 2가지 방법
// 1. 세션에서 내 정보를 바로 조회 // 2. 세션에서 id 또는 회원번호를 통해 DB를
조회 Member m = (Member) session.getAttribute("member"); int memberNo =
