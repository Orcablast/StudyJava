      ...
      <form action="/updateMember" method="post" id="mypage">
        ...
        <div id="btn-box">
          ...
          <c:if test="${m.memberId eq 'admin' }">
            <button class="btn btn-outline-danger btn-lg" type="button" onclick="location.href='/adminPage'">
              회원관리
            </button>
          </c:if>
          <c:if test="${m.memberId ne 'admin' }">
            <button class="btn btn-outline-danger btn-lg" type="button" onclick="deleteMember('${m.memberId}')">
              회원탈퇴
            </button>
          </c:if>
        </div>
